...
const TString sNameTag = "_pT_Atlas";
double systErrorWidth = 0.5;
double pointXShift = -0.2;
...
int plotNominal_pT_withAtlas()
{
	...
	TFile* myFile_ppAtlas = new TFile("HEPData-ins1292798-v1-Table_9.root", "READ");

	TH1F* h_Result_ppAtlas = (TH1F*)myFile_ppAtlas->Get("Table 9/Hist1D_y1");
	TH1F* h_Result_ppAtlasStatUp = (TH1F*)myFile_ppAtlas->Get("Table 9/Hist1D_y1_e1"); //symmetric
	TH1F* h_Result_ppAtlasStatDown = (TH1F*)myFile_ppAtlas->Get("Table 9/Hist1D_y1_e1"); 
	TH1F* h_Result_ppAtlasSystUp = (TH1F*)myFile_ppAtlas->Get("Table 9/Hist1D_y1_e2"); //symmetric
	TH1F* h_Result_ppAtlasSystDown = (TH1F*)myFile_ppAtlas->Get("Table 9/Hist1D_y1_e2");
	...
	gAS_Result->SetMarkerStyle(71); //71
	...
	/// and now ATLAS
		...
		// cook them
	TGraphAsymmErrors* gAS_Result_ppAtlas = new TGraphAsymmErrors(h_Result_ppAtlas); // create ppAtlas results and set points
	TGraphAsymmErrors* gAS_Result_ppAtlas_Syst = new TGraphAsymmErrors(h_Result_ppAtlas); // create ppAtlas systematics - set points

	for (int i = 0; i < gAS_Result_ppAtlas->GetN(); i++)
	{
		gAS_Result_ppAtlas->SetPointEYhigh(i, h_Result_ppAtlasStatUp->GetBinContent(i + 1));
		gAS_Result_ppAtlas->SetPointEYlow(i, h_Result_ppAtlasStatDown->GetBinContent(i + 1));
		gAS_Result_ppAtlas_Syst->SetPointEYhigh(i, h_Result_ppAtlasSystUp->GetBinContent(i + 1));
		gAS_Result_ppAtlas_Syst->SetPointEYlow(i, h_Result_ppAtlasSystDown->GetBinContent(i + 1));
		gAS_Result_ppAtlas_Syst->SetPointEXhigh(i, systErrorWidth);
		gAS_Result_ppAtlas_Syst->SetPointEXlow(i, systErrorWidth);
	}
	RemoveXError(gAS_Result_ppAtlas);

	// plot them

	gAS_Result_ppAtlas_Syst->SetLineWidth(2);
	gAS_Result_ppAtlas_Syst->SetLineColor(kBlack);
	gAS_Result_ppAtlas_Syst->SetMarkerSize(_markerSize);
	gAS_Result_ppAtlas_Syst->SetFillColor(kBlack);
	gAS_Result_ppAtlas_Syst->SetFillStyle(3013);

	gAS_Result_ppAtlas->SetMarkerSize(0.9*_markerSize);
	gAS_Result_ppAtlas->SetMarkerColor(kBlack);
	gAS_Result_ppAtlas->SetMarkerStyle(25);
	gAS_Result_ppAtlas->SetLineColor(kBlack);
	gAS_Result_ppAtlas->SetLineWidth(2);


	ShiftXPosition(gAS_Result_ppAtlas_Syst, pointXShift);
	ShiftXPosition(gAS_Result_ppAtlas, pointXShift);

	gAS_Result_ppAtlas_Syst->Draw("2");
	gAS_Result_ppAtlas->Draw("ZPE");
	...
	TLegend*leg = new TLegend(0.55, 0.18, 0.85, 0.47, "");
