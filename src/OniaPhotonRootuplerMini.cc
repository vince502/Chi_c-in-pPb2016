// -*- C++ -*-
//
// Package:    OniaPhotonRootuplerMini
// Class:      OniaPhotonRootuplerMini
// 
/**
...
class OniaPhotonRootuplerMini:public edm::EDAnalyzer {
      public:
	explicit OniaPhotonRootuplerMini(const edm::ParameterSet &);
	~OniaPhotonRootuplerMini();
...
OniaPhotonRootuplerMini::OniaPhotonRootuplerMini(const edm::ParameterSet & iConfig): 
...
OniaPhotonRootuplerMini::~OniaPhotonRootuplerMini() {}
...
bool OniaPhotonRootuplerMini::isAncestor(const reco::Candidate* ancestor, const reco::Candidate * particle) {
...
void OniaPhotonRootuplerMini::analyze(const edm::Event & iEvent, const edm::EventSetup & iSetup) {
  using namespace edm;
  using namespace std;
...
void OniaPhotonRootuplerMini::fillDescriptions(edm::ConfigurationDescriptions & descriptions) {
...
DEFINE_FWK_MODULE(OniaPhotonRootuplerMini);
