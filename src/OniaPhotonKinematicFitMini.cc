// -*- C++ -*-
//
// Package:    OniaPhotonKinematicFitMini
// Class:      OniaPhotonKinematicFitMini
// 
/**
 ...
 Implementation:
     ...
     Adapter for SKIMMED Onia and Photon by Alberto Sanchez-Hernandez
*/
...
class OniaPhotonKinematicFitMini : public edm::EDProducer {
  public:
    explicit OniaPhotonKinematicFitMini(const edm::ParameterSet&);
    ~OniaPhotonKinematicFitMini();
...
OniaPhotonKinematicFitMini::OniaPhotonKinematicFitMini(const edm::ParameterSet& iConfig) {
...
OniaPhotonKinematicFitMini::~OniaPhotonKinematicFitMini() {}
...
void OniaPhotonKinematicFitMini::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  for (pat::CompositeCandidateCollection::const_iterator chiCand=chiCandHandle->begin();chiCand!=chiCandHandle->end();++chiCand) { 
    ...
    convTracks.push_back((dynamic_cast<const pat::PackedCandidate*>(chiCand->daughter("photon")->daughter("ele1")))->pseudoTrack());
    convTracks.push_back((dynamic_cast<const pat::PackedCandidate*>(chiCand->daughter("photon")->daughter("ele2")))->pseudoTrack());
  ...
  // now sort by vProb
  //OniaPhotonKinematicFitMini::GreaterByVProb<pat::CompositeCandidate> vPComparator;
...
void OniaPhotonKinematicFitMini::beginJob() {}

// ------------ method called once each job just after ending the event loop  ------------
void OniaPhotonKinematicFitMini::endJob() {}

// ------------ method called when starting to processes a run  ------------
void OniaPhotonKinematicFitMini::beginRun(edm::Run&, edm::EventSetup const&) {}

// ------------ method called when ending the processing of a run  ------------
void OniaPhotonKinematicFitMini::endRun(edm::Run&, edm::EventSetup const&) {}

// ------------ method called when starting to processes a luminosity block  ------------
void OniaPhotonKinematicFitMini::beginLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&) {}

// ------------ method called when ending the processing of a luminosity block  ------------
void OniaPhotonKinematicFitMini::endLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&) {}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void OniaPhotonKinematicFitMini::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(OniaPhotonKinematicFitMini);
